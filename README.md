...
Simply pulling `lscr.io/linuxserver/quassel-core` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
docker run -d \
  ...
  -v <path to data>:/config \
  --restart unless-stopped \
  lscr.io/linuxserver/quassel-core
```
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/quassel-core`
...
* Update the image: `docker pull lscr.io/linuxserver/quassel-core`
...
* **01.01.22:** - Rebase to alpine 3.14. Add boost-dev as build dep.
